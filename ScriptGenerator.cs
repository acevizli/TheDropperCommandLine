...
namespace TheDropper.Generators
{
    internal class ScriptGenerator
    {
        ...
        public string Generate(string payloadContent, string name, string outExtension)
        {
            string payloadFile = Path.Combine(Directory.GetCurrentDirectory(), $"{name}.{outExtension}");
